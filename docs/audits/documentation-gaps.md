...
- production secret rotation and container UID/GID coordination;
...
- headless Secret Service availability after logout/reboot until an operator
  verifies the selected keyring backend on the target VPS.
